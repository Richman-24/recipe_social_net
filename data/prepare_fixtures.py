...
# Сей скрипт берёт данные из поставляемого файла ingredients.json и переводит их
# в поддерживаемый формат для установки фикстур через loaddata
# и сохраняет его в data/fixtures.json
